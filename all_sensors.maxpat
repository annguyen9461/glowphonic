...
, 		{
			"box" : 			{
				...
				"patching_rect" : [ 3899.0, 2780.0, 137.0, 22.0 ],
				"id" : "obj-354",
				"numinlets" : 3,
				"numoutlets" : 2,
...
, 		{
			"box" : 			{
				...
				"patching_rect" : [ 3750.0, 2780.0, 137.0, 22.0 ],
				"id" : "obj-353",
				"numinlets" : 3,
				"numoutlets" : 2,
				"outlettype" : [ "signal", "signal" ]
...
, 		{
			"box" : 			{
				...
				"patching_rect" : [ 3816.0, 2746.0, 137.0, 22.0 ],
				"id" : "obj-352",
				"numinlets" : 3,
				"numoutlets" : 2,
				"outlettype" : [ "signal", "signal" ]
...
, 		{
			"box" : 			{
				"maxclass" : "newobj",
				"text" : "buffer~ Loop4",
				"patching_rect" : [ 3668.0, 3086.0, 83.0, 22.0 ],
				"id" : "obj-343",
				"numinlets" : 1,
				"numoutlets" : 2,
...
, 		{
			"box" : 			{
				"maxclass" : "newobj",
				"text" : "buffer~ Loop3",
				"patching_rect" : [ 3566.0, 3086.0, 83.0, 22.0 ],
				"id" : "obj-342",
				"numinlets" : 1,
				"numoutlets" : 2,
				"outlettype" : [ "float", "bang" ]
...
, 		{
			"box" : 			{
				"maxclass" : "newobj",
				"text" : "buffer~ Loop2",
				"patching_rect" : [ 3468.0, 3086.0, 83.0, 22.0 ],
				"id" : "obj-341",
				"numinlets" : 1,
				"numoutlets" : 2,
				"outlettype" : [ "float", "bang" ]
...
, 		{
			"box" : 			{
				"maxclass" : "newobj",
				"text" : "dac~",
				"patching_rect" : [ 2705.0, 3777.0, 35.0, 22.0 ],
				"id" : "obj-319",
				"numinlets" : 2,
				"numoutlets" : 0
			}
...
, 		{
			"box" : 			{
				"maxclass" : "gain~",
				"patching_rect" : [ 2712.0, 3593.0, 22.0, 140.0 ],
...
, 		{
			"box" : 			{
				"maxclass" : "meter~",
				"patching_rect" : [ 2728.0, 3563.0, 80.0, 13.0 ],
				"id" : "obj-317",
				"numinlets" : 1,
				"numoutlets" : 1,
				"outlettype" : [ "float" ]
...
, 		{
			"box" : 			{
				"maxclass" : "number",
				"patching_rect" : [ 2797.0, 3458.0, 50.0, 22.0 ],
				"id" : "obj-316",
				"numinlets" : 1,
				"parameter_enable" : 0,
				"numoutlets" : 2,
...
, 		{
			"box" : 			{
				"maxclass" : "newobj",
				"text" : "tapout~",
				"patching_rect" : [ 2714.0, 3517.0, 49.0, 22.0 ],
				"id" : "obj-314",
				"numinlets" : 1,
				"numoutlets" : 1,
				"outlettype" : [ "signal" ]
...
, 		{
			"box" : 			{
				"maxclass" : "toggle",
				"patching_rect" : [ 3985.0, 2840.0, 24.0, 24.0 ],
				"id" : "obj-310",
				"numinlets" : 1,
				"parameter_enable" : 0,
				"numoutlets" : 1,
...
, 		{
			"box" : 			{
				"maxclass" : "newobj",
				"text" : "tapin~ 5000",
				"patching_rect" : [ 2714.0, 3405.0, 72.0, 22.0 ],
				"id" : "obj-307",
				"numinlets" : 1,
				"numoutlets" : 1,
...
, 		{
			"box" : 			{
				"maxclass" : "meter~",
				"patching_rect" : [ 2714.0, 3363.0, 80.0, 13.0 ],
				"id" : "obj-306",
				"numinlets" : 1,
				"numoutlets" : 1,
				"outlettype" : [ "float" ]
...
, 		{
			"box" : 			{
				"maxclass" : "newobj",
				"text" : "adc~",
				"patching_rect" : [ 2714.0, 3321.0, 35.0, 22.0 ],
				"id" : "obj-303",
				"numinlets" : 1,
				"numoutlets" : 2,
				"outlettype" : [ "signal", "signal" ]
...
, 		{
			"box" : 			{
				"maxclass" : "newobj",
				"text" : "buffer~ play",
				"patching_rect" : [ 3187.0, 2969.0, 71.0, 22.0 ],
				"id" : "obj-181",
				"numinlets" : 1,
				"numoutlets" : 2,
				"outlettype" : [ "float", "bang" ]
...
, 		{
			"box" : 			{
				"maxclass" : "newobj",
				"text" : "sig~ 1",
				"patching_rect" : [ 3730.0, 2698.0, 41.0, 22.0 ],
				"id" : "obj-190",
				"numinlets" : 1,
				"numoutlets" : 1,
				"outlettype" : [ "signal" ]
...
, 		{
			"box" : 			{
				...
				"patching_rect" : [ 3555.0, 2746.0, 137.0, 22.0 ],
				"id" : "obj-192",
				"numinlets" : 3,
				"numoutlets" : 2,
				"outlettype" : [ "signal", "signal" ]
...
, 		{
			"box" : 			{
				"maxclass" : "ezadc~",
				"patching_rect" : [ 3239.0, 2681.0, 45.0, 45.0 ],
				"id" : "obj-194",
				"numinlets" : 1,
				"numoutlets" : 2,
				"outlettype" : [ "signal", "signal" ]
